    ...
    >
      ...
      >
        <textarea
          ...
          className={classNames(
            'w-full ltr:pl-4 rtl:pr-4 pt-4 ltr:pr-16 rtl:pl-16 outline-none resize-none text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary bg-transparent text-sm',
